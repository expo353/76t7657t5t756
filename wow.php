...
$HCSET['FILTER_REF_LIST'] = 'amazon   github vacso.life'; // 'regExp()';
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v2-787171913&js=false&stage='.$HCSET['stage'];
